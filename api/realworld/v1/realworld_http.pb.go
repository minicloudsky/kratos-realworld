...
func RegisterRealworldHTTPServer(s *http.Server, srv RealworldHTTPServer) {
	...
	r.POST("/api/user", _Realworld_GetCurrentUser0_HTTP_Handler(srv))
	...
	r.POST("/api/articles/comment/{slug}/comments", _Realworld_AddComment0_HTTP_Handler(srv))
	r.GET("/api/articles/{slug}/comments", _Realworld_GetComments0_HTTP_Handler(srv))
	r.DELETE("/api/comment/{slug}/comments/{id}", _Realworld_DeleteComment0_HTTP_Handler(srv))
...
func _Realworld_GetCurrentUser0_HTTP_Handler(srv RealworldHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in GetCurrentUserReply
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, "/realworld.v1.Realworld/GetCurrentUser")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetCurrentUser(ctx, req.(*GetCurrentUserReply))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
type RealworldHTTPClient interface {
	...
	GetComments(ctx context.Context, req *GetCommentRequest, opts ...http.CallOption) (rsp *MultipleCommentsReply, err error)
	GetCurrentUser(ctx context.Context, req *GetCurrentUserReply, opts ...http.CallOption) (rsp *UserReply, err error)
...
func (c *RealworldHTTPClientImpl) AddComment(ctx context.Context, in *AddCommentRequest, opts ...http.CallOption) (*SingleCommentReply, error) {
	...
	pattern := "/api/articles/comment/{slug}/comments"
...
func (c *RealworldHTTPClientImpl) DeleteComment(ctx context.Context, in *DeleteCommentRequest, opts ...http.CallOption) (*SingleCommentReply, error) {
	var out SingleCommentReply
	pattern := "/api/comment/{slug}/comments/{id}"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *RealworldHTTPClientImpl) GetComments(ctx context.Context, in *GetCommentRequest, opts ...http.CallOption) (*MultipleCommentsReply, error) {
...
func (c *RealworldHTTPClientImpl) GetCurrentUser(ctx context.Context, in *GetCurrentUserReply, opts ...http.CallOption) (*UserReply, error) {
	var out UserReply
	pattern := "/api/user"
	path := binding.EncodeURL(pattern, in, false)
